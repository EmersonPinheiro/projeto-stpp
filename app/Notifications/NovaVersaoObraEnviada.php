...
class NovaVersaoObraEnviada extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Nova versão de obra!')
                    ->greeting('Olá!')
                    ->line($this->propositor->nome.' '.$this->propositor->sobrenome.' enviou uma nova versão da obra "'.$this->obra->titulo.'".')
    ...
    {
        return [
            'message_user'=>$this->propositor->nome.' '.$this->propositor->sobrenome.' enviou uma nova versão da obra "'.$this->obra->titulo.'".',
            'message_report'=>'Nova versão enviada.',
