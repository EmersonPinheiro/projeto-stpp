...
class CreatePropostaTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->enum('situacao', ['Submetida', 'Em avaliação', 'Aguardando parecer', 'Aguardando decisão do Conselho Editorial', 'Em trâmite', 'Finalizada', 'Cancelada'])->default('Submetida');
